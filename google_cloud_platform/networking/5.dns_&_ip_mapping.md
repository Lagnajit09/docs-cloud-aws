...
This document explains **DNS resolution and IP address mapping in GCP from a complete beginner perspective**. It focuses on **how a request travels from a domain name to the correct VM**, covering **Cloud DNS, internal vs external DNS, zonal and global resolution, and IP translation**.
...
## 13. Common Beginner Confusions (Cleared)

- DNS does not route traffic
- DNS does not return internal IPs publicly
- External IPs are mappings, not VM identities

---

## 14. Final Mental Models
